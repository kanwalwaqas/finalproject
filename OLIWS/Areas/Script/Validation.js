...
function Check_AllFields() {
    ...
    var r = [8];
    r[0] = document.getElementById("rfname").innerHTML = validate_name('rfname', 'rerror', 2, 'N', 'For valid name enter elphabet only');
    ...
    //    ch = (c == 0) ? true : false;
    //    var a = [12];
    //    a[0] = document.getElementById("orgname").innerHTML = validate_name('orgname', 'orgrror', 2, 'N', 'For valid name enter elphabet only');
    //    a[1] = document.getElementById("orgemail").innerHTML = validate_name('orgemail', 'orgerror', '', 'E', 'Email formate should be abc@xyz.com ');
    //    a[2] = document.getElementById("passwrd").innerHTML = validate_name('passwrd', 'orgPerror', 6, 'P', 'please enter atleast 1 capital letter & contain these(#$%^&)');
    //    a[3] = document.getElementById("orgCpass").innerHTML = pass_match('passwrd', 'orgCpass', 'CnPerror');
    //    a[4] = document.getElementById("orgadd").innerHTML = validate_name('orgadd', 'aderog', 7, 'AD', 'addres is not valid');
    //    a[5] = document.getElementById("phnorg").innerHTML = validate_name('phnorg', 'oPherror', 10, 'Ph', 'Should be only numeric value');
    //    a[6] = document.getElementById("Fname").innerHTML = validate_name('Fname', 'Ferror', 2, 'N', 'For valid name enter elphabet only');
    //    a[7] = document.getElementById("Lname").innerHTML = validate_name('Lname', 'LLerror', 2, 'N', 'For valid name enter elphabet only');
    //    a[8] = document.getElementById("eemail").innerHTML = validate_name('eemail', 'eerror', '', 'E', 'Email formate should be abc@xyz.com ');
    //    a[9] = document.getElementById("owadrg").innerHTML = validate_name('owadrg', 'aderogw', 7, 'AD', 'addres is not valid');

    //    a[10] = document.getElementById("cnic").innerHTML = validate_name('owncnic', 'ownPerror', 14, 'C', 'Type CNIC with dashes virst digit should not be 0');
    //    a[11] = document.getElementById("phhn").innerHTML = validate_name('phhn', 'Phherror', 10, 'Ph', 'Should be only numeric value');
